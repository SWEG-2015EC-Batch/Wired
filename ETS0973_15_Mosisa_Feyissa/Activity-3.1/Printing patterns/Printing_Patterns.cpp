//This program prints diffrent patterns up-on the usere's interest 
#include<iostream>
using namespace std;
...
int main() {
    ...
    //Menu to choose a desired pattern
    ...
    //Outputs of the selected patterns
    switch (choice){
        case 'A':
        case 'a':
        ...
        cin>>length;
        //Printing numbers in rectangulay pattern
        for (int i = n; i <= m; ++i) {
        cout << i << " ";
        if (i == (width)) {
            cout << endl;
        ...
        case 'c':
         ...
         cin >> m; 
        //Printing hollow rectangular star pattern
        for (int i = 1; i <= n; ++i) {
            for (int j = 1; j <= m; ++j) {
                if (i == 1 || i == n || j == 1 || j == m) {
                    cout << "* ";
        ...
        case 'e':
         cout << "Enter the number of rows: ";
         cin >> n;
         //Piinting inverted half pyramid pattern
        for (int i = n; i >= 1; --i) {
            for (int j = 1; j <= i; ++j) {
                cout << "* ";
        }
        ...
        cout << "Enter the number of rows: ";
        cin >> n;
        //Printimg inverted full pyramid pattern
        for (int i = n; i >= 1; --i) {
            for (int j = 1; j <= n - i; ++j) {
                cout << "  ";
            }
        ...
        cout << "Enter the number of rows: ";
        cin >> n;
        //Printing hollow full pyramid pattern
        for (int i = n; i >= 1; --i) {
            for (int j = 1; j <= n - i; ++j) {
                cout << "  ";
             }
